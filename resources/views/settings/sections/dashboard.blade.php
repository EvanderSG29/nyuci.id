    ...
    @if (! $hasStore)
        <x-card class="p-6">
            ...
            <p class="mt-3 max-w-2xl text-sm leading-7 text-[var(--text-muted)]">
                Pengaturan chart dashboard membutuhkan konteks toko yang aktif. Lengkapi profil toko agar preset dashboard dapat dibuat
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                <a href="{{ route('settings.toko') }}" wire:navigate class="nyuci-btn-secondary">
    ...
    @else
        ...
        @if ($chartSettings)
            <x-card class="p-6">
                ...
                <form
                    id="settings-dashboard-defaults-form"
                    method="post"
                    action="{{ route('pengaturan-dashboard.defaults.update') }}"
            ...
            <x-card class="p-6">
                ...
                <form
                    id="settings-dashboard-overrides-form"
                    method="post"
                    action="{{ route('pengaturan-dashboard.overrides.update') }}"
                    class="mt-6 space-y-6"
                    data-settings-form
                >
                    @csrf
