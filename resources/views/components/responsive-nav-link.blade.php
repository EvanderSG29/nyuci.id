...
$classes = ($active ?? false)
            ? 'block w-full border-l-4 border-[var(--primary)] bg-[#0f172a] py-2 pe-4 ps-3 text-start text-base font-medium text-[var(--primary-ink)] transition duration-150 ease-in-out focus:border-[var(--primary-hover)] focus:bg-[#0f172a] focus:text-[var(--primary-ink)] focus:outline-none'
