...
$classes = ($active ?? false)
            ? 'inline-flex items-center border-b-2 border-[var(--primary)] px-1 pt-1 text-sm font-medium leading-5 text-[var(--primary-soft)] focus:border-[var(--primary-hover)] focus:outline-none transition duration-150 ease-in-out'
