                ...
                <div class="mx-auto flex min-h-[calc(100vh-3rem)] w-full max-w-4xl items-center justify-center">
                    <div class="w-full">
                        <div class="mb-6 flex justify-center">
                            <a href="{{ route('home') }}" class="inline-flex items-center gap-3 rounded-full border border-[var(--border-main)] bg-[var(--bg-card)] px-4 py-3 shadow-sm">
                                ...
                                <div class="text-left">
                                    <p class="text-sm font-semibold uppercase tracking-[0.2em] text-[var(--text-strong)]">Nyuci.id</p>
                                    <p class="text-xs text-[var(--text-muted)]">Checkout pembayaran laundry</p>
                                </div>
                            </a>
                        </div>
